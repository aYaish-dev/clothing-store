...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!$error) {
        ...
        mysqli_stmt_bind_param($update, "sddsisiiiiiii", $name, $price, $discount, $description, $category_id, $imageName, $stock_xs, $stock_s, $stock_m, $stock_l, $stock_xl, $stock_xxl, $id);
    ...
    <div class="card p-4 shadow mx-auto" style="max-width: 600px;">
        <form action="edit.php?id=<?php echo $id; ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="discount" step="0.01" class="form-control" value="<?php echo htmlspecialchars($product['discount'], ENT_QUOTES, 'UTF-8'); ?>">
            </div>
